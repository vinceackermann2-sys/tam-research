...
APP_NAME = "tam-research-aera-v23-seed8461-posthoc-341-repair1"
...
def preflight() -> dict:
    ...
    from tam_research.aera_v23_posthoc_diagnosis_repair1 import frozen_protocol
    ...
    print(
        "AERA_V23_POSTHOC_REPAIR1_PREFLIGHT_JSON=" + json.dumps(check, separators=(",", ":")),
        flush=True,
    )
    return check
...
def run_diagnostic() -> dict:
    ...
    from tam_research.aera_v23_posthoc_diagnosis_repair1 import run_posthoc_diagnosis
    ...
    print(
        "AERA_V23_POSTHOC_REPAIR1_L4_START_JSON="
        + json.dumps(
            {
...
def main() -> None:
    ...
    print(
        "AERA_V23_POSTHOC_REPAIR1_PREFLIGHT_LOCAL=" + json.dumps(check, separators=(",", ":")),
        flush=True,
    )
