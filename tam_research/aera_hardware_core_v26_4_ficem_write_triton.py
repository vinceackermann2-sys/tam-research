...
if triton is not None:
    ...
    def _write_adjudicate_map_kernel(
        ...
        # PyTorch tensor.ge(0.95) compares against the scalar after visibility in
        # the tensor's input dtype. Materialize the same numeric threshold in the
        # loaded similarity dtype before either duplicate comparison.
...
def fused_ficem_read_write_v26_4_protocol() -> dict[str, Any]:
    ...
    return {
        **read_protocol,
        ...
        "write_threshold_repair1_issue": 491,
