...
SECONDARY_CREDENTIAL_ALIASES = (
    ...
    ("account2", "MODAL_TOKEN_ID_2", "MODAL_TOKEN_SECRET_2"),
...
def resolve_secondary_credentials(
    ...
    """Resolve secondary aliases without returning or logging secret values."""
    ...
    return reference_id, reference_secret, labels
...
def select_from_environment(
    *,
    ...
    # Resolve every secondary alias before any Modal command. Conflicting or
    # partial aliases therefore fail closed before probing even the primary.
