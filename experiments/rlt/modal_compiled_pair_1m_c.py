...
JOB_ID = "rlt-compiled-paired-1m-modal-20260919-c"
...
app = modal.App("tam-rlt-compiled-paired-1m-20260919-c")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_compiled_pair_1m_c import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_compiled_pair_1m_c import train_compiled_pair_1m_c
    ...
    try:
        ...
        data_dir = Path("/tmp/rlt-compiled-pair-1m-data-c")
...
def main(job_path: str) -> None:
    ...
    print("RLT_COMPILED_PAIR_1M_C_RESULT_B64=" + result)
