...
app = modal.App("tam-rlt-scale15m-paired-16m-20260925-a")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_scale15m_pair_16m_a import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_scale15m_pair_16m_a import train_scale15m_pair_16m_a
    ...
    try:
        ...
        data_dir = Path("/tmp/rlt-scale15m-paired-16m-data-a")
        ...
        pair = train_scale15m_pair_16m_a(
...
def main(job_path: str) -> None:
    ...
    print("RLT_SCALE15M_PAIR_16M_A_RESULT_B64=" + result)
