...
app = modal.App("tam-rlt-compile-systems-20260915-c")
...
def run_profile_remote() -> str:
    ...
    for step in range(WARMUP_STEPS):
        one_step(eager_model, eager_model, eager_opt, step, mark_cudagraph_steps=False)
    torch.cuda.synchronize(device)
    ...
    payload = {
        ...
        "compile": {
            ...
            "dynamic": False,
            "cudagraph_mark_step_begin_each_microbatch": True,
        },
        "benchmark": {
