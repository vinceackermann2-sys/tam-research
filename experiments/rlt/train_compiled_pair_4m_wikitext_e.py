...
def train_compiled_pair_4m_wikitext_e(**kwargs: Any) -> dict[str, Any]:
    ...
    result["interpretation_ceiling"] = (
        "Single matched ~4M-token run trained and validated on pinned WikiText-103 raw data "
        "at ~7M parameters. This directly tests whether the FineWeb-Edu RLT advantage transfers "
        "to a different training corpus. One seed cannot establish corpus-level replication or "
        "a general architecture breakthrough."
    )
    return result
