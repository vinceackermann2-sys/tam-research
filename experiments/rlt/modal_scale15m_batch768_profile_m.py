...
JOB_ID = "rlt-systems-scale15m-batch768-modal-20260925-m"
ENGINEERING_SEED = 20_261_018
SEQ_LEN = 64
BATCH_SIZE = 768
EQUIV_BATCH = 2
WARMUP_STEPS = 1
...
app = modal.App("tam-rlt-systems-scale15m-batch768-20260925-m")
...
def run_profile_remote(job_json: str) -> str:
    ...
    expected = {
        "schema": 1,
        "job_id": JOB_ID,
        "task": "systems_scale15m_batch768_m",
...
def main(job_path: str) -> None:
    ...
    print("RLT_SYSTEMS_SCALE15M_BATCH768_RESULT_B64=" + result)
