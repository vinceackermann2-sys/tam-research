...
JOB_ID = "rlt-scale15m-paired-4m-modal-20260925-b"
...
app = modal.App("tam-rlt-scale15m-paired-4m-20260925-b")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_scale15m_pair_4m_b import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_scale15m_pair_4m_b import train_scale15m_pair_4m_b
...
def main(job_path: str) -> None:
    ...
    print("RLT_SCALE15M_PAIR_4M_B_RESULT_B64=" + result)
