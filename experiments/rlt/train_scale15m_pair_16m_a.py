...
PAIRED_BATCH_SEED = 20_271_016
PAIRED_EVAL_SEED = 20_291_016
COMPILE_PROBE_SEED = 20_301_016
...
def train_scale15m_pair_16m_a(**kwargs: Any) -> dict[str, Any]:
    ...
    result["interpretation_ceiling"] = (
        "Fresh-seed exact-parameter-matched ~15.1M scale test at a 16,777,216-token budget. "
