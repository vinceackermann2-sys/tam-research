...
JOB_ID = "rlt-compiled-paired-4m-wikitext-modal-20260923-a"
...
app = modal.App("tam-rlt-compiled-paired-4m-wikitext-20260923-a")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_compiled_pair_4m_wikitext_a import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_compiled_pair_4m_wikitext_a import train_compiled_pair_4m_wikitext_a
    import torch
    ...
    try:
        ...
        expected = {
            "schema": 1,
            "job_id": JOB_ID,
            "task": "compiled_paired_4m_wikitext_a",
        ...
        data_dir = Path("/tmp/rlt-compiled-pair-4m-wikitext-data")
        ...
        pair = train_compiled_pair_4m_wikitext_a(
...
def main(job_path: str) -> None:
    ...
    print("RLT_COMPILED_PAIR_4M_WIKITEXT_RESULT_B64=" + result)
