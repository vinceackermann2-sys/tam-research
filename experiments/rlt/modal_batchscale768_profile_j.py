...
PRIOR_I_GAP = 3.3441489978377668
...
app = modal.App("tam-rlt-batchscale768-systems-20260916-j")
...
def run_profile_remote() -> str:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("batch768 systems profile requires CUDA")
    ...
    if not semantic_equivalence:
        ...
        rlt_scale = rlt_result["tokens_per_second"] / PRIOR_I_TPS
        gap = transformer_result["tokens_per_second"] / rlt_result["tokens_per_second"]
        gap_improvement = PRIOR_I_GAP / gap
        classification = "PASS_BATCH768_SCALING_MATERIAL" if rlt_scale >= 1.15 else "PASS_BATCH768_SCALING_WEAK"
        rlt_result["speedup_vs_i_batch512"] = rlt_scale
    ...
    payload = {
        ...
        "profile": {"seq_len": SEQ_LEN, "batch_size": BATCH_SIZE,
                    ...
                    "prior_i_batch512_rlt_tokens_per_second": PRIOR_I_TPS,
                    "prior_i_transformer_gap_multiple": PRIOR_I_GAP,
        ...
        "derived": {"rlt_speedup_vs_i_batch512": rlt_scale,
                    "transformer_gap_multiple": gap,
                    "gap_improvement_vs_i": gap_improvement},
...
def main() -> None:
    ...
    print("RLT_BATCHSCALE768_RESULT_B64=" + result)
