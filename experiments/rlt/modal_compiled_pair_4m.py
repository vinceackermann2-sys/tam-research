...
JOB_ID = "rlt-compiled-paired-4m-modal-20260920-a"
...
app = modal.App("tam-rlt-compiled-paired-4m-20260920-a")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_compiled_pair_4m import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_compiled_pair_4m import train_compiled_pair_4m
...
def main(job_path: str) -> None:
    ...
    print("RLT_COMPILED_PAIR_4M_RESULT_B64=" + result)
