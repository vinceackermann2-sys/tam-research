...
JOB_ID = "rlt-compiled-paired-1m-modal-20260918-a"
...
app = modal.App("tam-rlt-compiled-paired-1m-20260918-a")
...
def run_pair_remote(job_json: str) -> str:
    from experiments.rlt.train_compiled_pair_1m import SCIENTIFIC_SEED as TRAINER_SEED
    from experiments.rlt.train_compiled_pair_1m import train_compiled_pair_1m
    ...
    try:
        ...
        expected = {
            "schema": 1,
            "job_id": JOB_ID,
            "task": "compiled_paired_1m",
            "scientific_seed": SCIENTIFIC_SEED,
            "requires_prior_pair_job_id": "rlt-compiled-paired-64k-modal-20260915-a",
...
def main(job_path: str) -> None:
    ...
    print("RLT_COMPILED_PAIR_1M_RESULT_B64=" + result)
