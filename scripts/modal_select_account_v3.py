...
"""CLI for the credential-alias-aware runtime-admission Modal selector (#1076)."""
...
_MODULE_PATH = (
    ...
    / "tam_research"
    / "modal_dual_account_v3.py"
)
_MODULE_NAME = "_tam_research_modal_dual_account_v3_standalone"
