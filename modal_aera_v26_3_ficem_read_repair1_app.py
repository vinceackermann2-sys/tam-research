...
APP_NAME = "tam-research-aera-v26-3-issue414-ficem-read-repair1"
VOLUME_NAME = "tam-research-data"
RESULT_PATH = "/vol/aera-v26/issue414-ficem-read-repair1/result.json"
MAX_GPU_SECONDS = 300
...
def preflight() -> dict:
    ...
    if result_path.exists():
        raise RuntimeError(
            f"refusing duplicate issue414 FICEM read repair1 run because result exists: {RESULT_PATH}"
        )
    check = {
        "contract": cpu_contract_preflight(),
        "repair_issue": 414,
        "source_failed_issue": 411,
        "source_failed_trigger": 413,
        "source_failed_actions_run": 33496856233,
        "result_path_absent": True,
        "gpu_authorized_by_preflight": False,
        "synthetic_only": True,
        "probe_reused_unchanged": True,
        "model_loaded": False,
    ...
    print(
        "AERA_V26_ISSUE414_FICEM_READ_REPAIR1_PREFLIGHT_JSON="
...
def run_probe() -> dict:
    ...
    print(
        "AERA_V26_ISSUE414_FICEM_READ_REPAIR1_L4_START_JSON="
        + json.dumps(
            {
    ...
    volume.commit()
    print(
        "AERA_V26_ISSUE414_FICEM_READ_REPAIR1_RESULT_JSON="
        + json.dumps(result, separators=(",", ":")),
        flush=True,
    )
    print(
        "AERA_V26_ISSUE414_FICEM_READ_REPAIR1_SUMMARY_JSON="
...
def main() -> None:
    ...
    print(
        "AERA_V26_ISSUE414_FICEM_READ_REPAIR1_PREFLIGHT_LOCAL="
        + json.dumps(check, separators=(",", ":")),
        flush=True,
    )
