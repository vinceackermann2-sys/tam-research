...
PHASE = "reduced-attention-pair1-100m-2b-v1"
...
APP_NAME = "cortex-reduced-attention-pair1-100m-2b-v1"
...
def _verify_model_contract() -> dict[str, Any]:
    ...
    if protocol.get("scientific_pair_seeds_reserved_not_consumed", [None])[0] != PAIR_SEED:
        raise RuntimeError("Pair-1 seed contract drift")
...
def verify_zero_gpu(source_sha: str, source_tree: str, harness_sha: str) -> str:
    ...
    payload = {
        "status": "PASS",
        "classification": "ZERO_GPU_REDUCED_ATTENTION_PAIR1_100M_2B_V1",
        "phase": PHASE,
...
def reserve_pair_dispatch(source_sha: str, source_tree: str, harness_sha: str) -> str:
    source, tree, harness = _validate_payload(source_sha, source_tree, harness_sha)
    volume.reload()
    root = Path(RESULT_ROOT)
    ...
    marker = {
        ...
        "classification": "SCIENTIFIC_REDUCED_ATTENTION_PAIR1_SINGLE_ATTEMPT",
        "phase": PHASE,
        "trigger_title": TRIGGER_TITLE,
        "source_sha": source,
        "source_tree": tree,
...
def _save_checkpoint(
    *,
    ...
    payload = {
        "experiment": PHASE,
        "classification": "SCIENTIFIC_PAIR1_CHECKPOINT_EVIDENCE_ONLY",
...
def _train_architecture(
    *,
    ...
    return {
        "status": "COMPLETE",
        "classification": "SCIENTIFIC_REDUCED_ATTENTION_PAIR1_ARCHITECTURE_COMPLETE",
        "source_sha": source_sha,
        "architecture": architecture,
...
def h100_train_one(
    ...
    attempt = {
        ...
        "classification": "SCIENTIFIC_REDUCED_ATTENTION_PAIR1_H100_FUNCTION_BEGAN",
        "source_sha": source,
        "source_tree": tree,
        "harness_sha": harness,
        "architecture": architecture,
    ...
    try:
        ...
        payload = {
            "status": "COMPLETE",
            "classification": "SCIENTIFIC_REDUCED_ATTENTION_PAIR1_ARCHITECTURE_RESULT",
            "source_sha": source,
            "source_tree": tree,
            "harness_sha": harness,
            "architecture": architecture,
        ...
        payload = {
            "status": "ERROR",
            "classification": "SCIENTIFIC_REDUCED_ATTENTION_PAIR1_ARCHITECTURE_ERROR_NO_RETRY",
            "source_sha": source,
            "source_tree": tree,
            "harness_sha": harness,
            "architecture": architecture,
...
def finalize_pair(source_sha: str, source_tree: str, harness_sha: str) -> str:
    ...
    if not both_complete:
        classification = "PAIR1_INCOMPLETE_NO_RETRY"
    elif not exact_geometry or not finite:
        classification = "PAIR1_INVALID_OR_NONFINITE_NO_RETRY"
    elif screen_pass:
        classification = "PAIR1_SCREEN_PASS"
    else:
        classification = "PAIR1_SCREEN_FAIL"

    payload = {
        "status": "PAIR1_COMPLETE" if both_complete else "PAIR1_INCOMPLETE",
...
def main(
    ...
    reservation = json.loads(reserve_pair_dispatch.remote(source, tree, harness))
