...
PHASE = "chm-v1-100m-stage-c-payload-gate-1017-v1"
CONTROL_ISSUE = 1017
PREREG_ISSUE = 1014
...
TRIGGER_TITLE = "[modal-chm-v1-100m-stage-c-payload-gate-1017-v1]"
...
RESULT_ROOT = "/vol/chm-v1/100m-stage-c-payload-gate/issue-1017/v1"
...
APP_NAME = "chm-v1-100m-stage-c-payload-gate-1017-v1"
...
def verify_zero_gpu(
    ...
    gate = {
        ...
        **_evidence(b, authority_comment_id), **state,
...
def reserve_dispatch(
    ...
    expected = _evidence(b, authority_comment_id)
...
def run_diagnostic(
    ...
    evidence = _evidence(b, authority)
    consumed = {
...
def inspect_state(
    ...
    return json.dumps({**_evidence(b, authority_comment_id), "root_exists": root.exists(), "files": files}, sort_keys=True)
