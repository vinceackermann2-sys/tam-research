...
APP_NAME = "tam-research-aera-v26-3-issue411-ficem-read"
VOLUME_NAME = "tam-research-data"
RESULT_PATH = "/vol/aera-v26/issue411-ficem-read/result.json"
MAX_GPU_SECONDS = 300
...
def preflight() -> dict:
    ...
    if result_path.exists():
        raise RuntimeError(
            f"refusing duplicate issue411 FICEM read run because result exists: {RESULT_PATH}"
        )
    check = {
    ...
    print(
        "AERA_V26_ISSUE411_FICEM_READ_PREFLIGHT_JSON="
...
def run_probe() -> dict:
    ...
    print(
        "AERA_V26_ISSUE411_FICEM_READ_L4_START_JSON="
        + json.dumps(
            {
    ...
    volume.commit()
    print(
        "AERA_V26_ISSUE411_FICEM_READ_RESULT_JSON="
        + json.dumps(result, separators=(",", ":")),
        flush=True,
    )
    print(
        "AERA_V26_ISSUE411_FICEM_READ_SUMMARY_JSON="
...
def main() -> None:
    ...
    print(
        "AERA_V26_ISSUE411_FICEM_READ_PREFLIGHT_LOCAL="
        + json.dumps(check, separators=(",", ":")),
        flush=True,
    )
