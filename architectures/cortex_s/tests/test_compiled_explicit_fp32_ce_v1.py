...
def test_loss_and_all_parameter_gradients_match_production_reference() -> None:
    ...
    candidate_loss = explicit_fp32_cross_entropy(candidate_logits, targets)
...
def test_builder_changes_only_optimizer_step_and_restores_exactly() -> None:
    ...
    with compiled_explicit_fp32_ce_training_builder():
        ...
        assert training_module._one_optimizer_step is candidate_module._one_optimizer_step_compiled_explicit_fp32_ce
    assert training_module._compile_model is original_compile
